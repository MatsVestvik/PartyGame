...
public class DisplayNumbers {
    ...
    public void setNumber(int number) {
        ...
        if (number < 0) {
            Image minusImage = LoadImage.load("numbers/pixil-frame--.png",8*scale, 12*scale, true, false);
        ...
        for (int i = 0; i < String.valueOf(number).length(); i++) {
            ...
            Image digitImage = LoadImage.load("numbers/pixil-frame-" + digit + ".png",8*scale, 12*scale, true, false);
